...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/07 10:29:05 by erlajoua          #+#    #+#             */
/*   Updated: 2021/06/07 10:29:05 by erlajoua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	Node(): m_previous(NULL), m_value(), m_next(NULL) {}
	Node(value_type const &val):
		m_previous(NULL), m_value(val), m_next(NULL) {}
